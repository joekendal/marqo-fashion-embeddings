...
For example, you may have a product JSON in your database with multiple fields. In this case you can vectorize the values by sorting the keys in alphabetical order, concatenating the string and string[] fields with spaces (excluding irrelevant info such as the id) and then lowercase the combined string.
